...
-   `Ctrl + Shift + M` 编辑 markdown 文件时，打开 markdown 预览文件
...
-   `Ctrl + B` 查找当前打开的文件
-   `Ctrl + C` 粘贴
-   `Ctrl + D` 选择字符串 （按住 Ctrl 再 +D 继续选择下个相同的字符串）
-   `Ctrl + F` 当前选中的文本，当前文件查找/替换
-   `Ctrl + E` 选中当前文本并查找/替换
-   `Ctrl + G` 跳转至第几行, 输入数字,回车跳至指定行
-   `Ctrl + J` 合并行（已选择需要合并的多行时）
-   `Ctrl + L` 选择整行（按住 Ctrl-继续选择下行）
-   `Ctrl + K` Backspace 从光标处删除至行首
-   `Ctrl + M` 光标移动至括号内开始或结束的位置
-   `Ctrl + N` 新建窗口
-   `Ctrl + P` 同 Ctrl+T 快速搜索项目中的文件
